          ...
          <div className="flex flex-col items-center space-y-4 text-center">
            <div className="space-y-2 max-w-4xl mx-auto">
              ...
              <p className="mx-auto max-w-[700px] text-gray-500 md:text-lg mt-4">
                ...
                teams to turn clarity into traction—whether that means reworking a go-to-market plan, fixing operational
                friction, or navigating a high-stakes career move.
              </p>
              <p className="mx-auto max-w-[700px] text-gray-500 md:text-lg mt-4">
                My approach is hands-on. We don&rsquo;t just talk—we build. Together, we&rsquo;ll design systems that scale,
                create accountability that lasts, and use tools like AI where they actually make a difference. No fluff.
                Just focused work that drives results.
              </p>
            </div>
          </div>
        </div>
